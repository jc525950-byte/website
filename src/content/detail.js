export const detailBreadcrumb = [
  { label: '南亚源码网', href: 'https://www.kvxr.com' },
  { label: 'H5源码', href: 'https://www.kvxr.com/h5yuanma' },
  { label: 'Lucky Dragons美国老虎机源码/英文版拉霸角子老虎机游戏' },
];
...
export const downloadInfo = {
  ...
  currency: 'USDT',
  ctaLabel: '立即购买',
  ctaLink: 'https://www.kvxr.com/wp-content/plugins/erphpdown/buy.php?postid=59263',
  tip: '当前网盘链接正常，请放心购买/下载',
};
...
export const detailSections = [
  {
    ...
    title: '概述',
    content: [
      'Lucky Dragons美国老虎机源码是 Pragmatic Play 推出的一款在线老虎机游戏。它具有中等波动性，玩家回报率 (RTP) 为 95.19%。游戏基础部分采用 5×4 网格布局，包含 50 条游戏线，并带有十个标准获胜符号。特色包括奖励旋转、一个支付分散符号和一个百搭符号。',
    ],
  },
  {
    id: 'design',
    title: '设计',
    content: [
      '中国主题的老虎机有很多，但很少有像幸运龙（Lucky Dragons）这样设计华丽而又简洁的。幸运龙是 Pragmatic Play 旗下经久不衰的老虎机之一。设计师们融入了一些经典符号，设计精良、清晰可见，同时还设计了分散符号致敬经典的中国主题。',
    ],
  },
  {
    id: 'features',
    title: '特征',
    content: [
      '这款游戏功能不多，只有赢奖倍数或赌博功能，但奖励旋转、百搭符号和支付分散符号是大多数玩家在游戏中寻找的功能。留意堆叠的巨龙，它们可能带来巨额奖金。',
    ],
  },
  {
    id: 'evaluation',
    title: '全面',
    content: ['我们很喜欢这款游戏的外观和机制，但它还可以有更多功能。'],
  },
  {
    id: 'theme',
    title: '主题',
    content: [
      '这是设计师打造的具有浓厚中国主题的老虎机之一，转轴上出现了吉祥动物、巨龙、佛像和风水币，营造出东方美学氛围。',
    ],
  },
];
